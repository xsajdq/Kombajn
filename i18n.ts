...
const translations = {
    en: {
        ...
        notifications: { title: 'Notifications', mark_all_read: 'Mark all as read', no_notifications: 'You have no new notifications.', comment_added: '{user} commented on {taskName}', task_assigned: 'You have been assigned to task {taskName}', status_changed: 'Status for {taskName} was changed to {status}', user_mentioned: '{user} mentioned you in {taskName}' },
    ...
    pl: {
        ...
        notifications: { title: 'Powiadomienia', mark_all_read: 'Oznacz wszystkie jako przeczytane', no_notifications: 'Nie masz nowych powiadomień.', comment_added: '{user} skomentował(a) {taskName}', task_assigned: 'Przydzielono Ci zadanie {taskName}', status_changed: 'Status dla {taskName} zmieniono na {status}', user_mentioned: '{user} wspomniał(a) o Tobie w {taskName}' },
