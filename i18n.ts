...
const translations = {
    en: {
        ...
        hr: {
            ...
            invite_member: 'Invite Member', invite_by_email: 'Invite by email', select_role: 'Select role', invite: 'Invite', create_workspace_title: 'Create new workspace', workspace_name_label: 'Workspace Name', create_button: 'Create', members_in: 'Members in', you: 'you', role_owner: 'Owner', role_manager: 'Manager', role_member: 'Member', role_client: 'Client', cannot_remove_owner: "Cannot remove the last owner of a workspace.", workspace_limit_reached: "You have reached your workspace limit for the current plan.", access_denied: "Access Denied", access_denied_desc: "You do not have permission to view this page.", remove: "Remove", no_pending_requests: 'No pending leave requests.', join_requests_title: "Workspace Join Requests", approve: "Approve", reject: "Reject"
        },
