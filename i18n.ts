...
const translations = {
    ...
    pl: {
        ...
        modals: {
            ...
            employee_detail_title: 'Szczegóły pracownika', contract_notes: 'Notatki do umowy', employment_notes: 'Notatki pracownicze i HR',
