...
const translations = {
    ...
    pl: {
        ...
        modals: {
            ...
            add_manual_time_log_title: 'Dodaj ręczny wpis czasu', add_time_log_button: 'Dodaj czas', time_to_log: 'Czas do zarejestrowania (np. 1h 30m)', time_placeholder: 'np. 2h 30m', date_worked: 'Data pracy',
