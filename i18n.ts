...
const translations = {
    en: {
        sidebar: { dashboard: 'Dashboard', projects: 'Projects', tasks: 'Tasks', team_calendar: 'Team Calendar', clients: 'Clients', sales: 'Sales', reports: 'Reports', invoices: 'Invoices', ai_assistant: 'AI Assistant', hr: 'HR', settings: 'Settings', billing: 'Billing', chat: 'Chat', goals: 'Goals', inventory: 'Inventory' },
        dashboard: {
    ...
    pl: {
        sidebar: { dashboard: 'Pulpit', projects: 'Projekty', tasks: 'Zadania', team_calendar: 'Kalendarz Zespołu', clients: 'Klienci', sales: 'Sprzedaż', reports: 'Raporty', invoices: 'Faktury', ai_assistant: 'Asystent AI', hr: 'Kadry', settings: 'Ustawienia', billing: 'Rozliczenia', chat: 'Czat', goals: 'Cele', inventory: 'Inwentarz' },
        dashboard: {
