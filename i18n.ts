...
const translations = {
    en: {
        sidebar: { dashboard: 'Dashboard', projects: 'Projects', tasks: 'Tasks', team_calendar: 'Team Calendar', clients: 'Clients', sales: 'Sales', reports: 'Reports', invoices: 'Invoices', ai_assistant: 'AI Assistant', hr: 'HR', settings: 'Settings', billing: 'Billing', chat: 'Chat', goals: 'Goals', inventory: 'Inventory', 'budget-and-expenses': 'Budget & Expenses', automations: 'Automations' },
        dashboard: {
        ...
        reports: {
            ...
            col_profit: 'Profit',
            col_margin: 'Margin',
            col_hours_tracked: 'Hours Tracked',
            col_tasks_completed: 'Tasks Completed',
        },
        settings: {
            title: 'Settings',
            theme: 'Theme',
            ...
            tab_projectTemplates: 'Project Templates',
            ...
            no_project_templates: 'No project templates created yet.',
        },
        modals: {
            cancel: 'Cancel',
            save: 'Save',
            ...
            map_role_to_user: 'Map "{roleName}" to a user',
        },
        command_palette: {
        ...
        automations: {
            title: 'Automations',
            subtitle: 'Automate repetitive tasks and workflows.',
            new_automation: 'New Automation',
            no_automations_title: 'No automations yet.',
            no_automations_desc: 'Create your first automation to streamline your work.',
            col_name: 'Name',
            col_status: 'Status',
            col_scope: 'Scope',
            col_trigger: 'Trigger',
            ...
            modal_title: 'Create Automation',
            modal_edit_title: 'Edit Automation',
            form_name: 'Automation Name',
            form_scope: 'Scope',
            form_scope_workspace: 'Entire Workspace',
            form_scope_project: 'Specific Project',
            form_project: 'Project',
            form_select_project: 'Select a project',
        }
    },
    pl: {
        sidebar: { dashboard: 'Pulpit', projects: 'Projekty', tasks: 'Zadania', team_calendar: 'Kalendarz Zespołu', clients: 'Klienci', sales: 'Sprzedaż', reports: 'Raporty', invoices: 'Faktury', ai_assistant: 'Asystent AI', hr: 'HR', settings: 'Ustawienia', billing: 'Rozliczenia', chat: 'Czat', goals: 'Cele', inventory: 'Inwentarz', 'budget-and-expenses': 'Budżet i Wydatki', automations: 'Automatyzacje' },
        dashboard: {
        ...
        reports: {
            ...
            kpi_total_cost: 'Całkowity Koszt',
            report_project_profitability: 'Rentowność Projektów',
            report_team_performance: 'Wydajność Zespołu',
            col_project: 'Projekt',
            col_revenue: 'Przychód',
            col_cost: 'Koszt',
            col_profit: 'Zysk',
            col_margin: 'Marża',
            col_hours_tracked: 'Zarejestrowane Godziny',
            col_tasks_completed: 'Ukończone Zadania',
        },
        settings: {
            title: 'Ustawienia',
            theme: 'Motyw',
            ...
            tab_projectTemplates: 'Szablony Projektów',
            ...
            due_date_offset: 'Termin (dni od startu)',
            assigned_role: 'Przypisana Rola',
            new_template: 'Nowy Szablon',
            edit_template: 'Edytuj Szablon',
            no_project_templates: 'Nie utworzono jeszcze szablonów projektów.',
        },
        modals: {
            cancel: 'Anuluj',
            save: 'Zapisz',
            ...
            map_role_to_user: 'Przypisz rolę "{roleName}" do użytkownika',
        },
        command_palette: {
        ...
        automations: {
            title: 'Automatyzacje',
            subtitle: 'Automatyzuj powtarzalne zadania i przepływy pracy.',
            new_automation: 'Nowa Automatyzacja',
            no_automations_title: 'Brak automatyzacji.',
            no_automations_desc: 'Utwórz swoją pierwszą automatyzację, aby usprawnić pracę.',
            col_name: 'Nazwa',
            col_status: 'Status',
            col_scope: 'Zakres',
            col_trigger: 'Wyzwalacz',
            col_actions: 'Akcje',
            scope_workspace: 'Obszar Roboczy',
            scope_project: 'Projekt',
            modal_title: 'Utwórz Automatyzację',
            modal_edit_title: 'Edytuj Automatyzację',
            form_name: 'Nazwa Automatyzacji',
            form_scope: 'Zakres',
            form_scope_workspace: 'Cały Obszar Roboczy',
            form_scope_project: 'Konkretny Projekt',
            form_project: 'Projekt',
            form_select_project: 'Wybierz projekt',
        }
    }
};
