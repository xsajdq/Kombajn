...
// Przeniesiono inicjalizację do wewnątrz handlera, aby móc prawidłowo obsłużyć błędy konfiguracji.
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    switch (req.method) {
     ...
     // This will now catch initialization errors too, e.g., missing env vars
     const errorMessage = error.message || 'An internal server error occurred. Check server logs and environment variables.';
